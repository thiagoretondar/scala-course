...
class ListsSuite extends FunSuite {
  ...
  test("sum of numbers of List(1,2,3) is equal to 6") {
    assert(sum(List(1,2,3)) === 6)
  }

  test("sum of zeros is equal to zero") {
    assert(sum(List(0,0,0)) === 0)
  }

  test("sum of opposite numbers is equal to zero") {
  ...
  test("max of numbers of List(1,2,3) is equal to 3") {
    assert(max(List(1,2,3)) === 3)
  }

  test("max of equals numbers is workin") {
    assert(max(List(1,2,3,3)) === 3)
  }

  test("max of negative numbers of List(-3,-5,-1) is equal to -1") {
    assert(max(List(-3, -5, -1)) === -1)
  }
